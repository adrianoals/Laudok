        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-laudok">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Desafios</h3>
            </div>
          ...
          {/* Soluções */}
          <div className="bg-laudok rounded-2xl p-8 shadow-laudok-dark text-white">
            <div className="flex items-center gap-4 mb-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="text-laudok-light">•</span>
                <p>Automação inteligente de processos</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-laudok-light">•</span>
                <p>Conformidade automática com NBR 16.747</p>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-laudok-light">•</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-laudok-light">•</span>
                <p>Suporte especializado e treinamento</p>
              </li>
            </ul>
          </div>
        </div>
